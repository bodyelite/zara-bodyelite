...
export async function checkAvailability() {
    try {
        ...
        const diaSemana = now.weekday;
        const horarioHoy = HORARIOS_ATENCION[diaSemana];
        
        let resumen = `REGLA DE ORO: HOY es día ${diaSemana} de la semana. Cerramos a las ${horarioHoy ? horarioHoy.fin : 'CERRADO'}:00. LA HORA ACTUAL ES ${now.toFormat('HH:mm')}. NUNCA ofrezcas horas que ya pasaron hoy o que estén fuera del horario de cierre de hoy.\nHorarios generales: Lun/Mie/Vie 10-19h, Mar/Jue 10-17h, Sab 10-13h.\n`;
        ...
        return resumen + (ocupados ? `OCUPADO: ${ocupados}.` : "Libre.") + " Revisa tu disponibilidad antes de ofrecer opciones.";

...
const respuestas = {
  ...
  rostro: "🌸 En rostro y cuello trabajamos *Face Elite*, *Face Antiage*, *Full Face*, *Pink Glow* y *Toxina Botulínica (Botox)*. \n\n🔹 *Face Elite*: HIFU 12D + RF + Pink Glow. Levanta, redefine contornos y mejora textura.\n🔹 *Face Antiage*: RF + HIFU + Pink Glow regenerativo. Disminuye arrugas y líneas finas.\n🔹 *Full Face*: rostro, cuello y escote con calibración IA según densidad tisular.\n🔹 *Pink Glow*: coctel de péptidos y ácido hialurónico para luminosidad y firmeza.\n🔹 *Botox*: relaja músculos para suavizar arrugas sin alterar gestos. Efecto visible a los 5 días. \n\nIndoloros. 4 a 6 sesiones o aplicación única. 💆‍♀️ Agenda tu diagnóstico gratuito 👉 https://agendamiento.reservo.cl/makereserva/agenda/f0Hq15w0M0nrxU8d7W64x5t2S6L4h9",

  precios: "💰 Los precios varían según diagnóstico y zona, pero los planes comienzan *desde $232.000 CLP*. La IA ajusta sesiones y energía según tu caso. 🌿 Agenda tu evaluación aquí 👉 https://agendamiento.reservo.cl/makereserva/agenda/f0Hq15w0M0nrxU8d7W64x5t2S6L4h9"
};
...
function detectarIntencion(text) {
  ...
  if (
    ...
    text.includes("frecuencia") ||
    text.includes("como es") ||
    text.includes("que usan")
  ) {
    return "🤖 En Body Elite usamos tecnologías no invasivas: HIFU 12D, Cavitación, Radiofrecuencia, EMS Sculptor, Pink Glow y Toxina Botulínica. ✨ Todas son sin dolor y calibradas con IA. 🗓️ Agenda evaluación gratuita 👉 https://agendamiento.reservo.cl/makereserva/agenda/f0Hq15w0M0nrxU8d7W64x5t2S6L4h9";
  }
...
app.listen(PORT, () => console.log("✅ Zara operativa sin errores tipográficos y avisos activos en puerto", PORT));

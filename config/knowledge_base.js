...
export const TRATAMIENTOS = {
  ...
  "lipo_body_elite": { nombre: "Plan Lipo Body Elite", precio: "$664.000", info: "🔥 Plan Estrella. HIFU + Lipoláser + EMS.", clave: "grasa, guata, abdomen, completo" },
...
1. **CORPORALES:** "Tenemos planes reductivos desde **$432.000** (Lipo Express)..."
2. **FACIALES/ROSTRO:** "Tenemos tratamientos faciales desde **$120.000** (Limpiezas)..."

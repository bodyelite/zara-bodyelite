...
¿Quieres que te muestre una opción más acotada o por zona específica?`;
  ...
  if (contexto === "pregunta_precio" && ["sí","si","dale","quiero"].some(p=>texto.includes(p))) {
    return `💛 Perfecto, en ese caso podrías considerar *Lipo Focalizada Reductiva* o *Body Tensor*, planes más cortos y accesibles, manteniendo tecnología avanzada.`;
  }

...
app.get('/monitor', (req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            .modal-content { background: #1e293b; padding: 25px; border-radius: 12px; width: 80%; max-width: 700px; }
        </style>
    </head>
    <body>
    <div class="sidebar">
    ...
    <div class="tools">
        ...
        <button class="btn btn-purple" onclick="openAnalytics()">📊 VER ANALYTICS</button>
        <button class="btn btn-purple" onclick="runDiagnostic()">🔍 DIAGNOSTICAR</button>
    </div>
    <div id="analyticsModal" class="modal" onclick="this.style.display='none'">
    ...
    <script>
        ...
        function openAnalytics(){ document.getElementById('analyticsModal').style.display='flex'; }
